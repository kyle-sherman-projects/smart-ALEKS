#!/usr/bin/env python3
"""
status_report.py —  RCE Extraction project pulse.
...
def render(plain: bool) -> str:
    ...
    L = []
    L.append(b(f" · RCE Extraction — status {today}"))
    L.append("")
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description=" RCE Extraction status digest.")
