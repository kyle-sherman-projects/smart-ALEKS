...
|------|---------------|---------------|------|
| Sherman Rodriguez | Build end-to-end extraction pipeline; apply systematic review methods to AI-assisted synthesis | Python engineering, Pydantic schema design, pipeline architecture, Git/GitHub | Data Engineer / AI-Prompt Engineer |
...
```bash
# Clone the repo
git clone https://github.com/-Repositories/cohort-2026.git
